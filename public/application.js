...
var config = {
  apiOrigins: {
    production: 'https://evening-oasis-55074.herokuapp.com/',
...
var eventsEvents = __webpack_require__(16);
...
var onEventIndex = function onEventIndex(event) {
  event.preventDefault();

  var data = getFormFields(this);
  api.eventIndex(data).then(ui.eventIndexSuccess).catch(ui.eventIndexFailure);
};

var onEventUpdate = function onEventUpdate(event) {
  event.preventDefault();

  var data = getFormFields(this);
  api.eventUpdate(data).then(ui.eventUpdateSuccess).catch(ui.eventUpdateFailure);
};

var onEventDelete = function onEventDelete(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.eventDelete(data).then(ui.eventDeleteSuccess).catch(ui.eventDeleteFailure);
};

var showCreateEvent = function showCreateEvent(event) {
  $('#create-event').toggle();
};

var showUpdateEvent = function showUpdateEvent(event) {
  $('#event-update').toggle();
};

var showDeleteEvent = function showDeleteEvent(event) {
  $('#event-delete').toggle();
};

var showMyEvents = function showMyEvents(event) {
  event.preventDefault();

  var data = getFormFields(this);
  api.userEvents(data).then(ui.userEventsSuccess).catch(ui.userEventsFailure);
};

var hideEvents = function hideEvents(event) {
  event.preventDefault();
  $('#eventslist').hide();
  $('#hide-events').hide();
...
var hideMyEvents = function hideMyEvents(event) {
  event.preventDefault();
  $('#usereventslist').hide();
  $('#hide-my-events').hide();
  $('#update-event-button').hide();
...
var eventIndex = function eventIndex(data) {
  return $.ajax({
    url: config.apiOrigin + '/events',
    method: 'GET',
    headers: {
...
var eventSearch = function eventSearch(id) {
  return $.ajax({
...
var eventUpdate = function eventUpdate(data) {
  return $.ajax({
...
var eventDelete = function eventDelete(data) {
  return $.ajax({
    url: config.apiOrigin + '/events/' + data.event.id,
    method: 'DELETE',
    headers: {
...
var userEvents = function userEvents(data) {
  return $.ajax({
...
var showEventsTemplate = __webpack_require__(19);
...
var eventIndexSuccess = function eventIndexSuccess(data) {
...
var eventIndexFailure = function eventIndexFailure() {
  $('#message').text('Error on get events. Please try again.');
};

var eventUpdateSuccess = function eventUpdateSuccess(data) {
  store.event = data.event;
  $('#message').text('Event updated successfully');
  $('input').val('');
  var showEventsHtml = showEventsTemplate({ events: store.event.id });
...
var eventUpdateFailure = function eventUpdateFailure() {
  $('#message').text('event update failed');
};

var eventDeleteSuccess = function eventDeleteSuccess(data) {
...
var eventDeleteFailure = function eventDeleteFailure() {
  $('#message').text('event delete failed');
};

var userEventsSuccess = function userEventsSuccess(data) {
...
var userEventsFailure = function userEventsFailure() {
  $('#message').text('your event index failed');
};

module.exports = {
  eventIndexSuccess: eventIndexSuccess,
  eventIndexFailure: eventIndexFailure,
  createEventSuccess: createEventSuccess,
  createEventFailure: createEventFailure,
  eventUpdateSuccess: eventUpdateSuccess,
  eventUpdateFailure: eventUpdateFailure,
  eventDeleteSuccess: eventDeleteSuccess,
  eventDeleteFailure: eventDeleteFailure,
  userEventsSuccess: userEventsSuccess,
  userEventsFailure: userEventsFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
